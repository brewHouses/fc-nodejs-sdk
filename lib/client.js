...
class Client {
   ...
   * @return {Promise} 返回 Function 信息
   */
  createLargeFunction(serviceName, options, headers) {
    var getTmpOssTokenOptions = {
      functionName: String(options.functionName),
    };
    return this.post(`/inner/services/${serviceName}/functions/getTmpOssToken`, getTmpOssTokenOptions, headers)
   ...
   */
  updateLargeFunction(serviceName, functionName, options, headers) {
    var getTmpOssTokenOptions = {
